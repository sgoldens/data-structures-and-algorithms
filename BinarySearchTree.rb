...
#
# Binary Search Trees are a special pattern of the Tree pattern. They must follow the algorithmic rules which say the left child of the parent is always lesser and
# the right child is always greater than its parent. If there is already a child in the direction you must move while traversing the tree, you repeat the same rules until
# an avaialble space is found. 
#
##########
# Unit Tests
##########
